namespace GXPEngine
{
    ...
    public class Key
    {
        ...
        // Num pad:
        public const int NUMPAD_PAGEUP = 298;
        public const int NUMPAD_PAGEDOWN = 299;
        public const int NUMPAD_HOME = 300;
        public const int NUMPAD_END = 301;
        public const int NUMPAD_INSERT = 302;
        ...
        public const int NUMPAD_DIV = 312;
        public const int NUMPAD_TIMES = 313;
        public const int MINUS = 314;
        public const int PLUS = 315;
        public const int NUMPAD_DELETE = 316;
        public const int NUMPAD_ENTER = 318;
        ...
        public const int MINUS_UNDERSCORE = 45;
